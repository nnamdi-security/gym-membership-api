...
class GymClassRepository:
    ...
    def get_all(
        ...
        statement = select(GymClass).order_by(GymClass.starts_at)
    ...
    def create(
        ...
        self.session.add(gym_class)
        self.session.commit()
        self.session.refresh(gym_class)
    ...
    def get_by_id_for_update(
        ...
        statement = select(GymClass).where(GymClass.id == class_id).with_for_update()
